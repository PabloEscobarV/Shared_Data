...
/*   Updated: 2025/10/27 02:26:02 by Pablo Escob      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool check_new_data(test_data_t **test_info, int size)
{
	...
	for (int i = 0; i < size; ++i)
	{
		for (int j = 0; j < NUM_SYNC_PARAM; ++j)
		{
...
bool **crt_received(int size)
{
	...
	for (int i = 0; i < size; ++i)
	{
		received[i] = new bool[NUM_SYNC_PARAM];
		for (int j = 0; j < NUM_SYNC_PARAM; ++j)
		{
			received[i][j] = false;
		}
...
{
	most_popular_t *stat_data = new most_popular_t[NUM_SYNC_PARAM];
...
test_data_t **crt_test_data_t(int size)
{
	...
	for (int i = 0; i < size; ++i)
	{
		test_data[i] = new test_data_t[NUM_SYNC_PARAM];
	}
	for (int i = 0; i < size; ++i)
	{
		for (int j = 0; j < NUM_SYNC_PARAM; ++j)
...
int main()
{
	...
	param_data = new ParamData[count];
