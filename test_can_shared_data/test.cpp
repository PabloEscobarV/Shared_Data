...
ParamData	*old_param_data;
Can_shared_data *shared_data;
...
bool	check_param_data(ParamData *param_data, ParamData *old_param_data)
{
	bool changed = false;
...
void	send_ssv(udp_data_t& udp_data, SharedData<P_COUNT> *shared_data, ParamData *param_data)
{
	can_data_t	can_data {};
...
void	crt_trhreads(SharedData<P_COUNT> *shared_data, ParamData *param_data, ParamData *old_param_data)
{
...
void	init_param_data(ParamData *param_data, ParamData *old_param_data, uint16_t step_kef)
{
...
void	print_param_data(ParamData *param_data)
{
	for (uint16_t i = 0; i < P_COUNT; ++i)
	{
